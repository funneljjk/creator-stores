...
function buildPrompt(c) {
  ...
  return [
    ...
    '  "coaching": [{"title":"오프라인 코칭/클래스 상품명 — 이 채널 주제 그대로","mode":"1:1 오프라인|오프라인 워크숍 중 하나","minutes":60,"seats":1,"priceKRW":120000,"schedule":"매주 화·목 저녁 식 짧은 일정 문구","desc":"무엇을 봐주고 무엇을 얻는지 2문장"}] (정확히 2개: 1:1 세션, 단체 워크숍 순),',
    '  "lives": [{"title":"실시간 라이브 클래스/웨비나명 — 이 채널 주제 그대로","minutes":90,"seats":30,"priceKRW":39000,"schedule":"격주 수요일 저녁 8시 식 문구","desc":"라이브로 무엇을 배우고 Q&A로 무엇을 얻는지 2문장"}] (정확히 2개),',
